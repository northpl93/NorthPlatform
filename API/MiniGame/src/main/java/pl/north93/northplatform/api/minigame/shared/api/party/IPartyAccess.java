package pl.north93.northplatform.api.minigame.shared.api.party;
...
public interface IPartyAccess extends IParty
{
    ...
    boolean removePlayer(Identity playerIdentity, LeavePartyNetEvent.LeavePartyReason reason) throws PlayerNotFoundException;
