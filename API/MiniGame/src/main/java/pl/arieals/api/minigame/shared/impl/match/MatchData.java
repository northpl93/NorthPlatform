...
/*default*/ class MatchData
{
    ...
    public MatchData(final UUID matchId, final UUID arenaId, final UUID serverId, final GameIdentity game, final Instant startTime, final Collection<Identity> startParticipants)
    {
