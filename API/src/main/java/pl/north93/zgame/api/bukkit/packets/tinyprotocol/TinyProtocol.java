package pl.north93.zgame.api.bukkit.packets.tinyprotocol;

import static pl.north93.zgame.api.bukkit.packets.tinyprotocol.Reflection.*;
    ...
    public void uninjectChannel(final Channel channel) {
        ...
        channel.eventLoop().execute(new Runnable() {
            ...
            public void run() {
                ...
                {
                    TinyProtocol.this.plugin.getLogger().warning("Exception occurred during handler remove. (" + exc.getMessage() + ")");
                }
            }
