...
public class BukkitCommandsManager implements ICommandsManager
{
    ...
    private class WrappedNorthCommand extends Command
    {
        ...
        public WrappedNorthCommand(final NorthCommand wrapped)
        {
            ...
            this.setPermissionMessage(ChatUtils.translateAlternateColorCodes(BukkitCommandsManager.this.apiMessages.getString("command.no_permissions")));
        }
        ...
        public boolean execute(final CommandSender commandSender, final String label, final String[] args)
        {
            ...
            {
                commandSender.sendMessage(ChatUtils.translateAlternateColorCodes(BukkitCommandsManager.this.apiMessages.getString("command.no_permissions")));
                return true;
            }
