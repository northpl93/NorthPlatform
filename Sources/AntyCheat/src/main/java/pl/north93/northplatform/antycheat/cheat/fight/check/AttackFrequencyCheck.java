package pl.north93.northplatform.antycheat.cheat.fight.check;
...
import pl.north93.northplatform.antycheat.event.impl.InteractWithEntityTimelineEvent;
import pl.north93.northplatform.antycheat.event.impl.InteractWithEntityTimelineEvent.EntityAction;
...
public class AttackFrequencyCheck implements TimelineAnalyser
{
    ...
    public SingleAnalysisResult analyse(final PlayerData data, final TimelineWalker timelineWalker)
    {
        ...
        final double avg = sum / (double) size;
